...
with open('tarefas.json', 'r', ecoding='utf-8') as arquivo:
...
def adicionar_tarefas():
    ...
    with open('tarefas.json', 'w', ecoding='utf-8') as arquivo:
         json.dump(tarefas, arquivo, indent=4, ensure_acii=False)
